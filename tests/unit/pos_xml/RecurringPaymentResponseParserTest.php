...
use Platron\multicarta\pos_xml\RecurringPaymentResponseParser;

class RecurringPaymentResponseParserTest extends ResponseParserTest {
	...
	public function testSuccessResponse(){
		...
		$parser = new RecurringPaymentResponseParser($this->createResponse($xml));
