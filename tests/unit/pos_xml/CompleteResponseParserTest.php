...
use Platron\multicarta\pos_xml\CompleteResponseParser;

class CompleteResponseParserTest extends ResponseParserTest {
	...
	public function testSuccessResponse(){
		...
		$parser = new CompleteResponseParser($this->createResponse($xml));
